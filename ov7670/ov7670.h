...
#define QQVGA
  ...
  #define IMG_X 160
  #define IMG_Y 120
  #define IMG_SIZE (IMG_X*IMG_Y*2) //Multiply by 4 rather than 2, because of bug on the PCB, where data is connected to bits[9:2]
                                  //Because of which DCMI is being operated in 10bit mode, rather than 8bit.
#endif

#define CAM_RST_GPIO_CLK RCC_AHB1Periph_GPIOB
